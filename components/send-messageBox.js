...
//     const sendMessageButton = this.shadowRoot.querySelector('.rightbutton');
...
customElements.define("send-message-box",
    class extends HTMLElement {
        constructor() {
            ...
            template.innerHTML = `
        <link rel="stylesheet" href="style.css">
        <div class="input-msg"  tabindex="1">
        <!-- message input -->
        <div class="textStyle" >
            <svg class="svgs" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="bi bi-paperclip" viewBox="0 0 16 16">
      ...
      `;
            ...
            sendMessageButton.addEventListener("click", () => {
                ...
                if (messageText.trim() !== "") {
                    // Dispatch a custom event to send the message text to the message list
                    this.dispatchEvent(
...
sendMessageBox.addEventListener("messageSent", (event) => {
    const messageText = event.detail;
    // Add the sender's message to the message list
    messageList.addMessage("You", messageText);
});